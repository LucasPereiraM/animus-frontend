...
export default function Receitas() {
  ...
  const handleRecipeClick = (book: Receita) => {
    setSelectedReceita(book);
  };

  useEffect(() => {
    if (selectedReceita && receitaDetailsRef.current) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col mt-20 mb-10">
        <h2 className="text-4xl text-gray-600 md:w-full w-[300px]">
          Escolha uma receita
        </h2>
        <p className="text-lg text-wrap  md:w-[530px] w-[300px]">
          Clique na receita para abrir os ingredientes e modo de preparo ou
          busque um livro...
        </p>
      </div>
        ...
        <>
          ...
          {viewMode === "grid" ? (
            <div className="h-[800px] overflow-y-auto mx-auto w-fit mb-20">
              <RecipesGridLayout
                items={filteredRecipes.map((item) => item.receita)}
      ...
      {selectedReceita && (
        ...
        >
          <h3 className="text-3xl text-primary mb-4 w-[400px] text-center max-w-full px-4">
