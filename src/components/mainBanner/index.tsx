    ...
    return (
        <div className="font-raleway tracking-wide flex flex-col gap-5 mx-auto mt-32 mb-52 px-4 sm:px-6 max-w-7xl">
            <div className="flex flex-col sm:flex-row gap-10 items-center">
                <h1 className="text-4xl sm:text-6xl lg:text-8xl text-bannerMain text-center sm:text-left lg:ml-5">
            ...
            <div className="flex justify-center sm:justify-end -mr-0 sm:-mr-32 lg:mr-10">
                <button>
                    <Image
                        src="/icons/angry.svg"
                        alt="emoção - raiva"
